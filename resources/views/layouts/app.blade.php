...
<head>
    ...
    <link rel="icon" href="{{ asset('lugano-health-favicon1.ico') }}">
    <!-- CSRF Token -->
            ...
            <div class="container">
                <a class="navbar-brand d-flex align-items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <div class="logo_laravel w-25">
                            <img src="/lugano-health-logo-1.png" href="{{ route('dashboard') }}" alt="..."
                                class="img-fluid ">
                        </div>
                    </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li>
                            <a class="nav-item mt-3 mt-md-0 text-center ms-md-3 text-white ms-0"
                                href="{{ route('token') }}">Test Pagamento</a>
                        </li>
                    </ul>
