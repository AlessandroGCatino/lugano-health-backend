            ...
            <div class="col-9 row">
                <div class="col-6">
                    ...
                    <div class="d-flex justify-content-between">
                        <a class="bg-primary text-white my-3 py-5 px-4 rounded-3 row"
                            href="{{ route('doctors.edit', session('doctor')->slug) }}">Informazioni Medico</a>
                        <a class="bg-primary text-white my-3 py-5 px-4 rounded-3 row"
                            href="{{ route('messages.index', session('doctor')->slug) }}">Messaggi Ricevuti</a>
                        <a class="bg-primary text-white my-3 py-5 px-4 rounded-3 row"
                            href="{{ route('reviews.index', session('doctor')->slug) }}">Recensioni Ricevute</a>
                        <a class="bg-primary text-white my-3 py-5 px-4 rounded-3 row"
                            href="{{ route('sponsorizations.index') }}">Sponsorizzazioni</a>
                    ...
                    <div class="col-6 d-flex flex-column">
                        ...
                        <a class="btn btn-success mt-4" href="{{ route('doctors.edit', session('doctor')->slug) }}">MODIFICA
                            PROFILO</a>
                        <a class="btn btn-success mt-4" href="{{ route('messages.index', session('doctor')) }}">MESSAGGI
                            RICEVUTI</a>
                        <a class="btn btn-success mt-4"
                            href="{{ route('reviews.index', session('doctor')->id) }}">RECENSIONI</a>
